...
espacios_piso2 = [
    ...
    Espacios(22, "Cuarto Oscuro de Fotografía", crear_actividad_unica(actividad_fotografia, 22), habitabilidad1, [(fuente_luz1, 1)], 5, 40.0)
]
...
edificio_dia = Edificio(
    ...
    paredes=paredes,
    ruta_archivo="objetos/edificio_dia.json"
)

edificio_noche = Edificio(
    habitaciones=espacios_piso1 + espacios_piso2 + espacios_piso3,
    paredes=paredes,
    ruta_archivo="objetos/edificio_noche.json"
)
...
# Guardar los edificios de día y noche en archivos JSON
with open('objetos/edificio_dia.json', 'w', encoding="utf-8") as f:
    json.dump(edificio_dia.to_dict(), f, indent=4, ensure_ascii=False)

with open('objetos/edificio_noche.json', 'w', encoding="utf-8") as f:
    json.dump(edificio_noche.to_dict(), f, indent=4, ensure_ascii=False)
