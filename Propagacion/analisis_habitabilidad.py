...
from Propagacion.propagacion import PropagacionLuz

def calcular_habitabilidad(is_night): # is_day = 1 si es de día, 0 si es de noche
...
if __name__ == '__main__':
    calcular_habitabilidad(is_night=True) # True si es de día, False si es de noche